...
plot.PlotScatterXYSave(files, 'pondGOSrexEGDmixte', 'pondaspectRatioporphEGDmixte', 'combSort', 'massif', 'lithologyDef', 'facies_EGDmixte', 'massif', ';', sort = 'sscat_Olivine')
plot.PlotScatterXYSave(files, 'pondGOSrexEGDmixte', 'pondaspectRatioporphEGDmixte', 'combSort', 'massif', 'lithologyDef', 'facies_EGDmixte', 'massif', ';', sort = 'sscat_Orthopyroxene')
plot.PlotScatterXYSave(files, 'pondGOSrexEGDmixte', 'pondaspectRatioporphEGDmixte', 'combSort', 'massif', 'lithologyDef', 'facies_EGDmixte', 'massif', ';', sort = 'sscat_Clinopyroxene')
plot.PlotScatterXYSave(files, 'J', 'BA', 'index', 'sscat', 'sscat', 'sscat', 'sscat', ';', xlim = [0, 15], ylim = [0, 1], sort = 'subcat_all')
plot.PlotScatterXYSave(files, 'J', 'BA', 'index', 'sscat', 'sscat', 'sscat', 'sscat', ';', xlim = [0, 15], ylim = [0, 1], sort = 'subcat_neo')
plot.PlotScatterXYSave(files, 'J', 'BA', 'index', 'sscat', 'sscat', 'sscat', 'sscat', ';', xlim = [0, 15], ylim = [0, 1], sort = 'subcat_porph')
...
plot.PlotScatterXYSave(files, 'BA', 'J', 'indexSamples', 'sscat', 'sscat', 'facies_EGDmixte', 'sscat', ';', xlim = [0, 1], ylim = [0, 15], sort = 'sscat_Olivine', c = 'J', cmap = 'sscat')
...
plot.PlotScatterXYSave(files, 'BA', 'J', 'indexSamples', 'massif', 'lithologyDef', 'facies_EGDmixte', 'massif', ';', xlim = [0, 1], ylim = [0, 15], sort = 'sscat_Olivine')
